...
import com.ssmalllucky.android.ui.adapter.WheelAdapter;
import com.ssmalllucky.android.ui.model.IPickerViewData;
 ...
 * 3d滚轮控件
 */
public class STWheelView extends View {
    ...
    public STWheelView(Context context) {
        this(context, null);
    }

    public STWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.STWheelView, 0, 0);
            mGravity = a.getInt(R.styleable.STWheelView_STWheelView_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.STWheelView_STWheelView_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.STWheelView_STWheelView_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.STWheelView_STWheelView_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.STWheelView_STWheelView_textSize, textSize);
            showUnit = a.getBoolean(R.styleable.STWheelView_STWheelView_showUnit, true);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //单位的Label
        if (showUnit && label != null) {
            int drawRightContentStart = drawCenterContentStart + textWidth + DisplayUtils.dip2px(context, 6f);
            //靠右并留出空隙
