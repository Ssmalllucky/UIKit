 ...
 * @author shuaijialin
 */
public class STSpinnerItem extends STContentItem {
    ...
    public STSpinnerItem(@NonNull Context context) {
        super(context);
    }

    public STSpinnerItem(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public STSpinnerItem(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(@NonNull Context context, AttributeSet attrs) {
        ...
        if (entries != null && entries.length != 0) {
            ...
            //生成数据适配器
            mAdapter = new PopupSpinnerAdapter(context, list);
            setAdapter(mAdapter);
        }

        LinearLayout.LayoutParams contentParams = (LayoutParams) contentTextView.getLayoutParams();
        ...
        setOnClickListener(v -> {
            ...
            popupSpinner = new PopupSpinner(mContext);
    ...
    private PopupSpinnerAdapter getAdapter() {
        return mAdapter;
    }

    public void setAdapter(PopupSpinnerAdapter adapter) {
    ...
    private PopupSpinnerAdapter.OnItemSelectedListener listener;

    public void setOnItemSelectedListener(PopupSpinnerAdapter.OnItemSelectedListener listener) {
