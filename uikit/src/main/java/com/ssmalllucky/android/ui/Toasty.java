...
/**
 * Based on <a href="https://github.com/GrenderG/Toasty">Toasty</a> <br />
 * <p>
 * Toast显示库，主要内容：<br />
 * <p>
 * 1. 取消系统Toast自带View，采用自定义View <br />
 * 2. 多种状态Toast显示样式 <br />
 * 3. 与界面Context解耦 <br />
 *
 * @author shuaijialin
 * <p>
 * 修改点：取消调用info、warning、error时的Context入参
 */
...
public class Toasty {
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        config.setGravity(Gravity.TOP, 0, 100);
        config.apply();
        ...
        setAnimation(currentToast.getView());
        return currentToast;
    }

    private static void setAnimation(View toastLayout) {
