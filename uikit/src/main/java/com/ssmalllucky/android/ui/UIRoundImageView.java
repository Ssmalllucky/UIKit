...
public class UIRoundImageView extends androidx.appcompat.widget.AppCompatImageView {
    /**
     * 图片的类型，圆形or圆角
     */
    private int type;
    ...
    public UIRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UIRoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * 默认为圆形图片
     */
    public UIRoundImageView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public UIRoundImageView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public UIRoundImageView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public UIRoundImageView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public UIRoundImageView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public UIRoundImageView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public UIRoundImageView setBorderWidth(int borderWidth) {
     ...
     * 设置描边颜色
     */
    public UIRoundImageView setBorderColor(int borderColor) {
