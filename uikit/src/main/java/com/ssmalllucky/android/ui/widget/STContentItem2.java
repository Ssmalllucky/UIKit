 ...
 * @author shuaijialin
 */
public class STContentItem2 extends STItem2 {
    ...
    public STContentItem2(@NonNull Context context) {
        super(context);
    }

    public STContentItem2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public STContentItem2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(@NonNull Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.STContentItem2);
            contentValue = a.getString(R.styleable.STContentItem2_STContentItem2_contentText);
            maxLines = a.getInteger(R.styleable.STContentItem2_STContentItem2_maxLines, 1);
            contentColor = a.getColor(R.styleable.STContentItem2_STContentItem2_contentColor, 0);
            contentBackground = a.getDrawable(R.styleable.STContentItem2_STContentItem2_contentBackground);
            contentSize = (a.getDimensionPixelSize(R.styleable.STContentItem2_STContentItem2_contentSize, context.getResources().getDimensionPixelSize(R.dimen.text_size_secondary_title)));
            hint = a.getString(R.styleable.STContentItem2_STContentItem2_hint);
        }
