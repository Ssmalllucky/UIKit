 ...
 * @Description
 */
public class PopupSpinnerAdapter extends RecyclerView.Adapter<PopupSpinnerAdapter.VH> {
    ...
    private STSpinnerItem spinnerItem;
    ...
    public PopupSpinnerAdapter(Context context, List<String> list, OnItemSelectedListener listener) {
        this.context = context;
        this.list = list;
    ...
    public void setSpinnerItem(STSpinnerItem spinnerItem) {
