...
public class ScaledLinearLayout extends LinearLayout {
    ...
    public ScaledLinearLayout(@NonNull Context context) {
        super(context);
    }

    public ScaledLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initAnimation();
    }

    public ScaledLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!hasDoneAnimation) {
                    ...
                    post(() -> {
                         ...
                         */
                        if (listener != null) {
                            listener.onClick(ScaledLinearLayout.this);
                        }
                    });
                }
                break;
